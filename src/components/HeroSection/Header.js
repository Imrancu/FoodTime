            ...
            <div className="mx-auto" style={{ maxWidth: 1092 }}>
                <div className="lg:flex justify-between pt-32">
                    <div className='lg:w-7/12'>
                        ...
                        <p className="mt-3 mb-5">Freshly made food delivered to your door.</p>
                        <div style={{ display: 'inline-block' }}>
                            <div className='bg-white flex border rounded-3xl'>
                                <div className='flex items-center'>
                                    <div style={{backgroundColor: '#FF8B00'}} className='h-9 w-9 ml-1 rounded-full'></div>
                                ...
                                <button style={{backgroundColor: '#396C03'}} className='flex py-2 px-5 text-white rounded-3xl'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 mr-2">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
                                </svg> Search</button>
                            </div>
                        </div>
                    </div>
                    <div className="lg:w-5/12 mt-10 relative" >
                        <div className='bg-white inline-block bg-opacity-50 rounded-lg p-5 absolute -top-6 right-16'>
                            <h4 style={{color: '#FF8B00'}} className='text-4xl font-bold flex items-center'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-9 h-9">
