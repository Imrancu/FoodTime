        ...
        <div className='border-b-2 bg-green-50'>
            <div className="navbar mx-auto" style={{ maxWidth: 1092 }}>
                ...
                <div className="navbar-end hidden w-full lg:flex">
                    ...
                    <button className='btn btn-primary text-lg rounded-3xl px-10'>Login</button>
                    <div className="indicator">
                        <span className="indicator-item p-1 badge badge-warning text-white">2</span>
                        <div className="bg-primary p-3 ml-5 text-white rounded-full"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
